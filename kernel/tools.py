...
class ToolRegistry:
    ...
    def list_files(self) -> List[str]:
        """Recursively lists all files in the workspace, excluding virtual environment (.venv), node_modules, and database folders."""
        exclude_dirs = {".git", ".venv", "__pycache__", ".ipynb_checkpoints", ".gemini", "kernel.egg-info", "node_modules", ".lancedb"}
        file_list = []
